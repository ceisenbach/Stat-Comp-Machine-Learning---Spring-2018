...
X_test$price = NULL
g(X_test)
b["cutGood"]+b["cutPremium"]+b["cutIdeal"]+b["colorE"]+b["colorF"]+b["colorG"]+b["colorH"]+b["colorI"]+b["colorJ"]+b["clarityIF"]+b["clarityVVS1"]+b["clarityVVS2"]+b["clarityVS1"]+b["clarityVS1"]+b["clarityVS2"]+b["claritySI1"]+b["claritySI2"]
...
mod6 = lm(price ~. * .  +poly(carat, 5, raw = TRUE)+poly(x, 5, raw = TRUE)+poly(y, 5, raw = TRUE)+poly(z, 5, raw = TRUE)+poly(depth, 5, raw = TRUE)+poly(table, 5, raw = TRUE),data.frame(X_test))
